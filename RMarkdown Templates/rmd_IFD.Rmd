     ...
     for(n in 1:length(subgroups)){
             for(i in 1:length(contDVs)){
                     ...
                     out[[x]]<-TreatmentEffects(mydata, treats=treatment, 
                                    ...
                                    comb="perm",
                                    clust=clust)
                     print(paste0("Continuous DV: ", contDVs[i], ", By: ", ifelse(subgroups[n]=="", "Full Sample", subgroups[n])))
                     print(out[[x]][[4]])
     ...
     for(n in 1:length(subgroups)){
             for(i in 1:length(binDVs)){
                     ...
                     out[[x]]<-TreatmentEffects(mydata,
                                    ...
                                    comb="perm",
                                    clust=clust)
                     print(paste0("Binary DV: ", binDVs[i], ", By: ", ifelse(subgroups[n]=="", "Full Sample", subgroups[n])))
                     print(out[[x]][[4]])
